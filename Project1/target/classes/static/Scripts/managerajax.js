    ...
    xhr.onreadystatechange = function(){
        ...
        if(xhr.readyState === 4 && xhr.status === 200){
            ...
            */
            ...
            new_div.id = reimbursement.reimbursement_description;
            ...
            new_para3.id = reimbursement.reimbursement_amount;
            ...
            new_button2.name = reimbursement.reimbursement_amount;
            ...
            new_button.name = reimbursement.reimbursement_description;
            new_button.type = "Approve";
            new_button.onclick = function () {approve(new_button2.id)};
